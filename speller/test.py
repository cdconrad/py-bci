...
# -*- coding: utf-8 -*-
"""
This is a test routine for the P3 speller. Unlike the train routine,
this needs to interpret epochs and classify them. The classifier then
needs to take its best bet at identifying the letter guessed.
"""
...
def test():
    ...
    while mainloop:
        ...
        if numtrials == 100:
            target = [2,2] #change this to what the classified value
            makeTarget(target)
            numtrials = 0
            screen.blit(background, (0,0)) #clean whole screen
            pygame.display.flip()
